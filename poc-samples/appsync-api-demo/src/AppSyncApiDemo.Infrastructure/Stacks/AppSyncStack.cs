...
public sealed class AppSyncStack : Stack
{
    public string AppSyncDomain { get; set; }

    internal AppSyncStack(Construct scope, string id, MultiStackProps props = null) : base(scope, id, props)
    {
        ...
        {
            SecretName = userPreferenceTableName,
        ...
        {
            SecretName = userDetailTableName,
        ...
        var gqlApi = new GraphqlApi(this, $"{id}-user-preference-api", new GraphqlApiProps
        {
            ...
            Definition = Definition.FromFile(Path.Combine(Directory.GetCurrentDirectory(),
                "src/AppSyncApiDemo.Infrastructure/Misc/schema.graphql"))
        });
        ...
        var getUserDetailFunction = new DotNetFunction(this, getUserDetailFunctionName,
            new DotNetFunctionProps()
            {
                ...
                Handler = "AppSyncApiDemo.Api::AppSyncApiDemo.Api.Functions.GetUserDetailFunction::Handler",
                LogRetention = RetentionDays.ONE_WEEK,
                ProjectDir = "./src/AppSyncApiDemo.Api/",
                Architecture = Architecture.X86_64,
                Tracing = Tracing.ACTIVE,
                Environment = new Dictionary<string, string>
                {
                    { "USER_DETAIL_TABLE_NAME", userDetailTableName },
                }
            });
        ...
        var upsertUserDetailFunction = new DotNetFunction(this, upsertUserDetailFunctionName,
            new DotNetFunctionProps()
            {
                ...
                Timeout = Duration.Seconds(30),
                Runtime = Runtime.DOTNET_8,
                Handler = "AppSyncApiDemo.Api::AppSyncApiDemo.Api.Functions.UpsertUserDetailFunction::Handler",
                LogRetention = RetentionDays.ONE_WEEK,
                ProjectDir = "./src/AppSyncApiDemo.Api/",
                Architecture = Architecture.X86_64,
                Tracing = Tracing.ACTIVE,
        ...
        var getUserPreferenceFunction = new DotNetFunction(this, getUserPreferenceFunctionName,
            new DotNetFunctionProps()
            {
                ...
                Timeout = Duration.Seconds(30),
                Runtime = Runtime.DOTNET_8,
                Handler = "AppSyncApiDemo.Api::AppSyncApiDemo.Api.Functions.GetUserPreferenceFunction::Handler",
                LogRetention = RetentionDays.ONE_WEEK,
                ProjectDir = "./src/AppSyncApiDemo.Api/",
                Architecture = Architecture.X86_64,
                Tracing = Tracing.ACTIVE,
                Environment = new Dictionary<string, string>
                {
                    { "PREFERENCE_TABLE_NAME", userPreferenceTableName },
                }
            });
        ...
        var upsertUserPreferenceFunction = new DotNetFunction(this, upsertUserPreferenceFunctionName,
            new DotNetFunctionProps()
            {
                ...
                Timeout = Duration.Seconds(30),
                Runtime = Runtime.DOTNET_8,
                Handler = "AppSyncApiDemo.Api::AppSyncApiDemo.Api.Functions.UpsertUserPreferenceFunction::Handler",
                LogRetention = RetentionDays.ONE_WEEK,
                ProjectDir = "./src/AppSyncApiDemo.Api/",
                Architecture = Architecture.X86_64,
                Tracing = Tracing.ACTIVE,
        ...
        var deleteUserPreferenceFunction = new DotNetFunction(this, deleteUserPreferenceFunctionName,
            new DotNetFunctionProps()
            {
                ...
                Timeout = Duration.Seconds(30),
                Runtime = Runtime.DOTNET_8,
                Handler = "AppSyncApiDemo.Api::AppSyncApiDemo.Api.Functions.DeleteUserPreferenceFunction::Handler",
                LogRetention = RetentionDays.ONE_WEEK,
                ProjectDir = "./src/AppSyncApiDemo.Api/",
                Architecture = Architecture.X86_64,
                Tracing = Tracing.ACTIVE,
        ...
        var fn1 = new AppsyncFunction(this, $"{id}-get-user-detail-appsync-function", new AppsyncFunctionProps
        {
            ...
            //     "src/AppSyncApiDemo.Infrastructure/Vtl/Query.GetUserDetail.Request.vtl")),
            ResponseMappingTemplate = MappingTemplate.FromFile(Path.Combine(Directory.GetCurrentDirectory(),
                "src/AppSyncApiDemo.Infrastructure/Vtl/Query.GetUserDetail.Response.vtl")),
        });
        var fn2 = new AppsyncFunction(this, $"{id}-get-user-preference-appsync-function", new AppsyncFunctionProps
        {
            ...
            // ResponseMappingTemplate = MappingTemplate.LambdaResult(),
            RequestMappingTemplate = MappingTemplate.FromFile(Path.Combine(Directory.GetCurrentDirectory(),
                "src/AppSyncApiDemo.Infrastructure/Vtl/Query.GetUserPreference.Request.vtl")),
            ResponseMappingTemplate = MappingTemplate.FromFile(Path.Combine(Directory.GetCurrentDirectory(),
                "src/AppSyncApiDemo.Infrastructure/Vtl/Query.GetUserPreference.Response.vtl")),
        });
        ...
        gqlApi.CreateResolver($"{id}-get-user-pipeline-resolver", new ResolverProps
        {
            ...
            // ResponseMappingTemplate = MappingTemplate.LambdaResult(),
            RequestMappingTemplate = MappingTemplate.FromFile(Path.Combine(Directory.GetCurrentDirectory(),
                "src/AppSyncApiDemo.Infrastructure/Vtl/Query.GetUserPipeline.Request.vtl")),
            ResponseMappingTemplate = MappingTemplate.FromFile(Path.Combine(Directory.GetCurrentDirectory(),
                "src/AppSyncApiDemo.Infrastructure/Vtl/Query.GetUserPipeline.Response.vtl")),
        });
